# Linux Command Prompt Resources
...
### Index
 ...
 ## Videos
   ...
   - [Learn Power Shell](https://www.techthoughts.info/learn-powershell-series/)

   - [Don Jones Teaches PowerShell](https://www.youtube.com/playlist?list=PL6D474E721138865A)

   - [PowerShell Master Class](https://www.youtube.com/watch?v=sQm4zRvvX58)

   - [Microsoft PowerShell For Beginners](https://www.youtube.com/watch?v=IHrGresKu2w)

   - [PowerShell Tutorial](https://www.youtube.com/watch?v=1t2giqs7_2E)
 ...
 ## Learning tools & Forums
   ...
   - [Windows Powershell](https://social.technet.microsoft.com/Forums/en-US/home?forum=winserverpowershell)

   - [Spice PowerShell Forum](https://community.spiceworks.com/programming/powershell)

   - [Mastering Windows PowerShell Scripting](https://learning.oreilly.com/library/view/mastering-windows-powershell/9781789536669/)
 ...
 ## PDFs
   ...
   - [Free Windows PowerShell Scripting Tutorial For Beginners](https://www.netwrix.com/powershell_tutorial_pdf.html)

   - [PowerShell For Beginners](https://f.hubspotusercontent20.net/hubfs/4890073/PowerShell%20for%20Beginners%20eBook.pdf)

   - [PowerShell](https://riptutorial.com/Download/powershell.pdf)

   - [Powershell Scripts PDF](https://www.pdfdrive.com/powershell-scripts-e33724052.html)
